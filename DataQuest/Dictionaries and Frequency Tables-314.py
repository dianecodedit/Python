...
for apps in content_ratings:
    content_ratings[apps] /= total_number_of_apps
    content_ratings[apps] = content_ratings[apps] * 100
...
rating_count = []
data_sizes = {"0 - 10000" : 0, "10000 - 100000" : 0, "100000 - 500000" : 0, "500000 - 1000000" : 0, "1000000+" : 0}

for app in apps_data[1:]:
    column = int(app[5])
    rating_count.append(column)
    if column <= 10000:
        data_sizes["0 - 10000"] += 1
    elif 10 < column >= 100000:
        data_sizes["10000 - 100000"] += 1
    elif 100000 < column >= 500000:
        data_sizes["100000 - 500000"] += 1
    elif 500000 < column >= 1000000:
        data_sizes["500000 - 1000000"] += 1
    else:
        data_sizes["1000000+"] += 1
